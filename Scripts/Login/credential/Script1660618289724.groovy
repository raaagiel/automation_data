...
WebUI.setText(findTestObject('Object Repository/input_atau_credential'), '')
...
WebUI.verifyElementPresent(findTestObject('div_Email atau nomor HP tidak boleh kosong'), 3)
